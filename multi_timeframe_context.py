...
def analyze_multi_timeframe_context(
    ...
    Missing higher-timeframe data never becomes a bearish signal.  The result
    is descriptive and auditable; callers decide how strongly it should affect
    an entry.
    """
    ...
    for timeframe in TIMEFRAME_WEIGHTS:
        ...
        context = analyze_multi_candle_context(closed)
