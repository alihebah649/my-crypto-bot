...
def test_strategy_universe_contains_the_established_16_spot_pairs():
    ...
    assert {"BTCUSDT", "ETHUSDT", "SOLUSDT", "LINKUSDT", "ADAUSDT", "DOTUSDT", "NEARUSDT", "ARBUSDT", "OPUSDT", "RENDERUSDT", "BNBUSDT", "AVAXUSDT", "ALGOUSDT", "ATOMUSDT", "FETUSDT", "LTCUSDT"} == set(TRADING_SYMBOLS)
