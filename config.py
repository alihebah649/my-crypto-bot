...
# Independent concurrent-position caps. Together they allow up to 25
# positions, while each strategy lane keeps its own limit.
MAX_OPEN_TRADES = 25
MAX_SCALPING_TRADES = 15
MAX_SWING_TRADES = 10
...
ALLOWED_SYMBOLS = [
    "BTCUSDT", "ETHUSDT", "BNBUSDT", "SOLUSDT", "LINKUSDT",
    "AVAXUSDT", "ADAUSDT", "ATOMUSDT", "NEARUSDT", "SUIUSDT",
    "INJUSDT", "RENDERUSDT",
]
